...
| File | Status | Changes |
|------|--------|---------|
| `docs/overview/PROJECT_SUMMARY.md` | ✅ Updated | - Added modular architecture details<br>- Updated file structure<br>- Added new technology stack<br>- Updated feature list |
| `docs/reference/QUICK_REFERENCE.md` | ✅ Updated | - Added builds/ directory commands<br>- Added modular endpoints<br>- Added RAG stats endpoints<br>- Updated Docker commands |
| `docs/setup/SETUP.md` | ✅ Updated | - Added architecture overview<br>- Updated start commands (cd builds/)<br>- Mentioned modular structure |
| `docs/reference/MODULAR_QUICK_REF.md` | ✅ Updated | - Updated directory structure<br>- Added version 2.1.0 info |
...
| File | Purpose |
|------|---------|
| `docs/architecture/CLEAN_ARCHITECTURE.md` | Complete refactoring details (411 → 79 lines) |
| `docs/flows/REQUEST_FLOW.md` | Visual request routing diagrams |
| `docs/architecture/MODULAR_ARCHITECTURE.md` | Deep dive into modular design |
...
- ✅ `docs/reference/MODULAR_QUICK_REF.md` - Quick commands

### Architecture & Design
- ✅ `docs/architecture/MODULAR_ARCHITECTURE.md` - Modular design
- ✅ `docs/architecture/CLEAN_ARCHITECTURE.md` - Refactoring details
- ✅ `docs/flows/REQUEST_FLOW.md` - Request routing
- ✅ `docs/CHAT_FLOW.md` - Communication flow

### Features & Usage
- ✅ `docs/guides/DUAL_SYSTEM_GUIDE.md` - RAG comparison
- ✅ `docs/MODEL_SELECTION.md` - Model information
- ✅ `docs/concepts/understand_rag_without_code.md` - RAG concepts

### Reference & Future
- ✅ `docs/reference/QUICK_REFERENCE.md` - Command reference
- ✅ `docs/overview/PROJECT_SUMMARY.md` - Project overview
- ✅ `docs/roadmap/future_scope.md` - Planned features
...
- Follow `docs/setup/SETUP.md` for setup
- Use `docs/reference/MODULAR_QUICK_REF.md` for quick commands
- Explore `docs/` for deep dives

### For Developers
- Read `docs/architecture/MODULAR_ARCHITECTURE.md` for architecture
- Check `docs/architecture/CLEAN_ARCHITECTURE.md` for design decisions
- See `docs/flows/REQUEST_FLOW.md` for routing logic
- Review `docs/roadmap/future_scope.md` for roadmap
